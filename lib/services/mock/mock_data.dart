...
class MockData {
  ...
  static Map<String, dynamic> get graduation => {
        ...
        'graduation_info': {
          ...
          'missing_courses_text':
              'CSE3007工程倫理與產業導論[3]、實習課程[0]',
        },
      };

  // ── 課表（114 下・大三下・目前修讀）────────────────

  static Map<String, dynamic> get schedule => {
        'status': 'success',
        'data': {
          'schedule': [
            {
  ...
  static Map<String, dynamic> calendarEvents(String year, {String? lang}) {
    ...
    final events = <Map<String, dynamic>>[
      // 上半年（第二學期）
      {'id': 'cal-01', 'date': '$y-02-17', 'name': isEn ? 'Spring Semester Begins' : '第二學期開學', 'link': '', 'isImportant': true},
      {'id': 'cal-02', 'date': '$y-02-17', 'name': isEn ? 'Add/Drop Period Begins' : '加退選開始', 'link': '', 'isImportant': false},
      {'id': 'cal-03', 'date': '$y-02-28', 'name': isEn ? 'Peace Memorial Day (No Classes)' : '和平紀念日放假', 'link': '', 'isImportant': false},
      {'id': 'cal-04', 'date': '$y-03-03', 'name': isEn ? 'Add/Drop Period Ends' : '加退選截止', 'link': '', 'isImportant': true},
      {'id': 'cal-05', 'date': '$y-04-04', 'name': isEn ? "Children's Day / Tomb Sweeping Day" : '兒童節/清明節連假', 'link': '', 'isImportant': false},
      {'id': 'cal-06', 'date': '$y-04-14', 'name': isEn ? 'Midterm Exam Week' : '期中考週', 'link': '', 'isImportant': true},
      {'id': 'cal-07', 'date': '$y-05-01', 'name': isEn ? 'Campus Sports Day' : '校慶運動會', 'link': '', 'isImportant': false},
      {'id': 'cal-08', 'date': '$y-06-16', 'name': isEn ? 'Final Exam Week' : '期末考週', 'link': '', 'isImportant': true},
      {'id': 'cal-09', 'date': '$y-06-21', 'name': isEn ? 'Graduation Ceremony' : '畢業典禮', 'link': '', 'isImportant': true},
      {'id': 'cal-10', 'date': '$y-06-28', 'name': isEn ? 'Summer Break Begins' : '暑假開始', 'link': '', 'isImportant': false},
      // 下半年（第一學期）
      {'id': 'cal-11', 'date': '$y-09-09', 'name': isEn ? 'Fall Semester Begins' : '第一學期開學', 'link': '', 'isImportant': true},
      {'id': 'cal-12', 'date': '$y-09-09', 'name': isEn ? 'Add/Drop Period Begins' : '加退選開始', 'link': '', 'isImportant': false},
      {'id': 'cal-13', 'date': '$y-09-22', 'name': isEn ? 'Add/Drop Period Ends' : '加退選截止', 'link': '', 'isImportant': true},
      {'id': 'cal-14', 'date': '$y-10-10', 'name': isEn ? 'National Day (No Classes)' : '國慶日放假', 'link': '', 'isImportant': false},
      {'id': 'cal-15', 'date': '$y-11-03', 'name': isEn ? 'Midterm Exam Week' : '期中考週', 'link': '', 'isImportant': true},
      {'id': 'cal-16', 'date': '$y-11-17', 'name': isEn ? 'Anniversary Celebration' : '校慶', 'link': '', 'isImportant': false},
      {'id': 'cal-17', 'date': '$y-12-22', 'name': isEn ? 'Final Exam Week' : '期末考週', 'link': '', 'isImportant': true},
      {'id': 'cal-18', 'date': '$y-01-01', 'name': isEn ? "New Year's Day" : '元旦放假', 'link': '', 'isImportant': false},
      {'id': 'cal-19', 'date': '$y-01-13', 'name': isEn ? 'Winter Break Begins' : '寒假開始', 'link': '', 'isImportant': false},
    ];
  ...
  static Map<String, dynamic> courseDetail({
    ...
    // 先從課表找
    final scheduleList =
        (schedule['data']?['schedule'] as List?) ?? const [];
